...
// Radio button manual otomatis
const radioBtns = document.querySelectorAll('input[name="pilihan"]');

radioBtns.forEach(function(radioBtn) {
  radioBtn.addEventListener('change', function() {
    const selectedValue = document.querySelector('input[name="pilihan"]:checked').value;
    
    const kontenYa = document.querySelector('#konten-ya');
    const kontenTidak = document.querySelector('#konten-tidak');
    
    if (selectedValue === "Ya") {
      kontenYa.style.display = "block";
      kontenTidak.style.display = "none";
    } else if (selectedValue === "Tidak") {
      kontenYa.style.display = "none";
      kontenTidak.style.display = "block";
    }
  });
});
